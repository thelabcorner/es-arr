...
> **From the same team: [ESON](https://github.com/thelabcorner/eson) — strict JSON for ExtendScript, [ESB64](https://github.com/thelabcorner/es-b64) — base64/UTF-8, [ESSTR](https://github.com/thelabcorner/esstr) — string trim, [ESCHARS](https://github.com/thelabcorner/es-chars) — native bulk byte ops, [ESPACK](https://github.com/thelabcorner/espack) — self-extracting ExternalObject bundles, [ESOBF](https://github.com/thelabcorner/esobf) — obfuscation, and [ArcFit.dev](https://arcfit.dev) — deterministic arc warp for Illustrator.**
